  ...
  export default {
    ...
    methods: {
      ...
      async submitForm() {
        ...
        try {
          const response = await axios.post('https://api-thesis-track.vercel.app/reset-password/request', {
            "email": this.loginEmail // Enviando o email inserido pelo usuário
          });
          ...
          if (response.status === 200) {
            ...
            // Redirecionar para a página de edição de senha
